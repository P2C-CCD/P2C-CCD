param(
    ...
    [int]$ChunkRows = 50000,
    [int]$DenseAssetLimit = 32,
    [int]$DensePairLimit = 128,
    [int]$DenseSamplesPerPair = 2,
...
$ShardDir = "src\datasets\training\rtstpf_paper_dataset_v3\shards\rtstpf_paper_dataset_v3_smoke_run_id"
$ShardReport = "src\benchmark\rtstpf_paper_dataset_v3_smoke_run_id.md"
$RunName = "rtstpf_paper_dataset_v3_smoke_run_id"
$ReportName = "rtstpf_paper_dataset_v3_smoke_training_run_id"
...
Write-Host "[2/3] Build v3 smoke shards"
...
Write-Host "[3/3] Train smoke STPF"
@"
...
result = run_tight_inclusion_stpf_training(
    ...
    train_eval_max_rows=200000,
    validation_eval_max_rows=100000,
)
